...
// import 'package:masjidfaarqaazam/SizeConfig.dart';
...
class FlutterAnalogClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // setup numbers
    final double numberRadius = tickRadius - bigTickWidth * SizeConfig.safeBlockVertical * 0.3;
    ...
    _paintHourHand(
        canvas, SizeConfig.safeBlockVertical * 2.1, (radius - borderWidth) / 20);

    if (showMinuteHand) {
      _paintMinuteHand(canvas, numberRadius, (radius - borderWidth) / 16);
    }
    if (showSecondHand) {
